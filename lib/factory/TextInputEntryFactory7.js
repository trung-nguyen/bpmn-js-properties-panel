...
var textField7 = function(translate, options, defaultParameters) {
  ...
  resource.html =
    ...
    '<div class="bpp-field-wrapper" ' +
      ...
      (canBeHidden ? 'data-show="isHidden"' : '') +
      '>' +
      '<input id="camunda-' + escapeHTML(resource.id) + '" type="text" name="' + escapeHTML(options.modelProperty) + '" placeholder="Nơi nhận"' +
        (canBeDisabled ? 'data-disable="isDisabled"' : '') +
        (canBeHidden ? 'data-show="isHidden"' : '') +
        ' />' +
