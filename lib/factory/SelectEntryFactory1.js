 ...
 * @return {Object}
 */
var selectbox1 = function(translate, options, defaultParameters) {
  ...
  resource.html =
    ...
    escapeHTML(modelProperty) + '"' +
        ...
        '<option value="data">Thêm mới</option>' +
        '<option value="mail">Nộidung</option>' +
        '<option value="notify">Khác</option>' +
