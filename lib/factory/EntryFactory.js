...
var textInputField = require('./TextInputEntryFactory'),
    textInputField3 = require('./TextInputEntryFactory3'),
    textInputField4 = require('./TextInputEntryFactory4'),
    textInputField5 = require('./TextInputEntryFactory5'),
    textInputField7 = require('./TextInputEntryFactory7'),

    checkboxField = require('./CheckboxEntryFactory'),
    checkboxField8 = require('./CheckboxEntryFactory8'),
    selectBoxField = require('./SelectEntryFactory'),
    selectBoxField1 = require('./SelectEntryFactory1'),
...
EntryFactory.textField3 = function(translate, options) {
  return textInputField3(translate, options, setDefaultParameters(options));
};
EntryFactory.textField4 = function(translate, options) {
  return textInputField4(translate, options, setDefaultParameters(options));
};
EntryFactory.textField5 = function(translate, options) {
  return textInputField5(translate, options, setDefaultParameters(options));
};
EntryFactory.textField7 = function(translate, options) {
  return textInputField7(translate, options, setDefaultParameters(options));
};
...
EntryFactory.checkbox8 = function(translate, options) {
  return checkboxField8(translate, options, setDefaultParameters(options));
};
...
EntryFactory.selectBox1 = function(translate, options) {
  return selectBoxField1(translate, options, setDefaultParameters(options));
};
