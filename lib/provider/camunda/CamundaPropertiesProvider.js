...
function createGeneralTabGroups(
  ...
  var generalGroup = {
    id: 'general',
    label: translate('Thông tin chung'),
    entries: []
  };
  ...
  var asyncGroup = {
    id : 'async',
    label: translate('Asynchronous Continuations1'),
    entries : []
  };
  ...
  var jobConfigurationGroup = {
    id : 'jobConfiguration',
    label : translate('Cấu hình công việc'),
    entries : [],
  ...
  var externalTaskGroup = {
    ...
    label : translate('Cấu hình tác vụ bên ngoài'),
    entries : [],
  ...
  var candidateStarterGroup = {
    ...
    label: translate('Cấu hình ứng viên dành cho người mới bắt đầu'),
    entries: []
  };
  ...
  var historyTimeToLiveGroup = {
    ...
    label: translate('Cấu hình lịch sử'),
    entries: []
  };
  ...
  var tasklistGroup = {
    id: 'tasklist',
    label: translate('Cấu hình danh sách tác vụ'),
    entries: []
  };
...
function createInputOutputTabGroups(element, bpmnFactory, elementTemplates, translate) {
  ...
  var inputParametersGroup = {
    id: 'input-parameters',
    label: translate('Tham số đầu vào'),
    entries: []
  };
  ...
  var outputParametersGroup = {
    ...
    label: translate('Tham số đầu ra'),
    entries: []
  };
...
function CamundaPropertiesProvider(
  ...
  this.getTabs = function(element) {
    ...
    var inputOutputTab = {
      id: 'input-output',
      label: translate('Đầu ra/Đầu vào'),
    ...
    var extensionsTab = {
      ...
      label: translate('Tiện ích mở rộng'),
